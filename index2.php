				...
				<tr>
					<td valign=top>
						...
						<? } ?>
							...
							<br /><br /><br />
							<a href="pub/index.php?c=1" class="top_pub"><b>Start Reading<br/>From Chapter 1</b></a>
							<br /><br /><br /><br />&nbsp;<br />
						</div>
							</td></tr>
						</table>
					...
					<td align=right valign=top width="300">
						...
						<center style="font-size: 1.5em;">
							...
							<br>
							<a href="pub/index.php?c=<?=$last_row['Chapter_Num']?>"  class="top_pub">Chapter <?=$last_row['Chapter_Num']?> - <?=$last_row['Title']?></a>
							</center>
							<br />
