...
|
	...
	<?	if ($slideshow[$slide + 1] != "") {	?>	<input type="hidden" value="<?=$slide + 1?>" id="slideshow_nextslide" /> <a href="javascript:slideshow_slide(<?=($slide + 1)?>)">	<? } else { ?>	<input type="hidden" value="0" id="slideshow_nextslide" /> <a href="javascript:slideshow_slide(0)">	<? } ?>	<img src="images/next.png" border=0<? if ($slideshow[$slide + 1] != "") { echo ' title="next"'; } ?>/>	</a> 
